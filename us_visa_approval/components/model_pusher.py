...
from us_visa_approval.cloud_storage.aws_storage import SimpleStorageService
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        ...
        try:
            ...
            self.usvisa_estimator.save_model(
                from_file=self.model_evaluation_artifact.trained_model_path) #it will upload the model to the s3 bucket
